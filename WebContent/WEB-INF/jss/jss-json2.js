/*
    jss-json2.js
    Mostly based on json2.js, see below. 
    The only modification is to allow for JSON encryption of java models that 
    extend the JSSEntity class. 
...
(function() {
	...
	function str(key, holder) {
		...
		case 'object':
			...
			//Make this script capable of handling java objects
		/*	if(value instanceof java.lang.Object){
				var gson = new om.google.gson.Gson();
				return gson.toJson(value);
			}
			
			// Change is for JSS specifics:
			
			if (typeof value.isJSSEntity === 'function'
					&& value.isJSSEntity() === true) {
			
				// We are dealing with a JSSEntity, use a Java implementation to
				// parse json.
				return value.getJSONString();
			}*/
